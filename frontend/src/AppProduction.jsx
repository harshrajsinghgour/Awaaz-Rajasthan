...
export default function AppProduction() {
  ...
  const filtered = useMemo(() => {
    ...
    if (savedOnly) {
      return savedItems.filter(n => !q || [n.title,n.excerpt,n.category,n.location,n.author].join(" ").toLowerCase().includes(q));
    }
  ...
  }, [news, savedItems, category, district, query, savedOnly]);
