const CACHE="awaaz-rajasthan-v1";
const APP_SHELL=["/","/index.html","/news-placeholder.svg"];
...
self.addEventListener("push",event=>{
  ...
  event.waitUntil(self.registration.showNotification(data.title||"आवाज़ राजस्थान",{
